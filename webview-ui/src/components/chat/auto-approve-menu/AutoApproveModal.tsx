			...
			<div
				...
				<div className="flex items-center gap-2">
					<VSCodeCheckbox
						...
						<span className="text-sm">{t("auto_approve.enable_notifications")}</span>
					</VSCodeCheckbox>
				</div>
				<div className="mt-1 text-xs text-muted-foreground">{t("auto_approve.notifications_privacy")}</div>
			</div>
		</div>
	)
}
